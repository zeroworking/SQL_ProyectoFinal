...
('CLI001', 'Juan Perez', 'juan.perez@example.com', '990123456', '1975-08-25', 1, 31),
('CLI002', 'Maria Lopez', 'maria.lopez@example.com', '990234567', '1976-12-13', 1, 11),
('CLI003', 'Pedro Rodriguez', 'pedro.rodriguez@example.com', '990345678', '1977-09-03', 1, 31),
('CLI004', 'Ana Martinez', 'ana.martinez@example.com', '990456789', '1979-02-14', 1, 11),
('CLI005', 'Luisa Sanchez', 'luisa.sanchez@example.com', '990567890', '1980-09-22', 1, 21),
('CLI006', 'Carlos Gomez', 'carlos.gomez@example.com', '990678901', '1981-06-15', 2, 21),
('CLI007', 'Laura Fernandez', 'laura.fernandez@example.com', '990789012', '1982-08-31', 1, 31),
('CLI008', 'Javier Ramirez', 'javier.ramirez@example.com', '990890123', '1982-10-03', 1, 18),
('CLI009', 'Sofia Alonso', 'sofia.alonso@example.com', '990901234', '1983-05-18', 1, 18),
('CLI010', 'Diego Herrera', 'diego.herrera@example.com', '990012345', '1983-12-30', 1, 22),
('CLI011', 'Elena Castro', 'elena.castro@example.com', '990123406', '1984-07-19', 1, 31),
('CLI012', 'Manuel Rubio', 'manuel.rubio@example.com', '990234067', '1984-09-22', 1, 22),
('CLI013', 'Carmen Jimenez', 'carmen.jimenez@example.com', '990345078', '1985-10-20', 1, 9),
('CLI014', 'Pablo Diaz', 'pablo.diaz@example.com', '990456089', '1986-04-26', 2, 17),
('CLI015', 'Rocio Navarro', 'rocio.navarro@example.com', '990567190', '1986-11-07', 1, 9),
('CLI016', 'Gonzalo Herrera', 'gonzalo.herrera@example.com', '990678201', '1987-11-11', 1, 17),
('CLI017', 'Raquel Gomez', 'raquel.gomez@example.com', '990789312', '1988-03-12', 1, 31),
('CLI018', 'Alberto Ruiz', 'alberto.ruiz@example.com', '990890423', '1988-07-14', 1, 5),
('CLI019', 'Julia Torres', 'julia.torres@example.com', '990901534', '1989-03-07', 2, 5),
('CLI020', 'Santiago Serrano', 'santiago.serrano@example.com', '990012645', '1990-02-15', 1, 31),
('CLI021', 'Eva Martin', 'eva.martin@example.com', '990123756', '1990-09-08', 1, 4),
('CLI022', 'Daniel Garcia', 'daniel.garcia@example.com', '990234867', '1991-10-03', 1, 14),
('CLI023', 'Patricia Moreno', 'patricia.moreno@example.com', '990345978', '1992-07-08', 1, 17),
('CLI024', 'Roberto Herrera', 'roberto.herrera@example.com', '990456089', '1993-06-28', 1, 15),
('CLI025', 'Beatriz Alvarez', 'beatriz.alvarez@example.com', '990567190', '1994-09-08', 1, 13),
('CLI026', 'Marcos Sanchez', 'marcos.sanchez@example.com', '990678201', '1995-04-17', 1, 13),
('CLI027', 'Natalia Jimenez', 'natalia.jimenez@example.com', '990789312', '1996-11-24', 1, 16),
('CLI028', 'Jorge Lopez', 'jorge.lopez@example.com', '990890423', '1997-08-02', 2, 11),
('CLI029', 'Adriana Gomez', 'adriana.gomez@example.com', '990901534', '1998-01-05', 1, 21),
('CLI030', 'Hector Martinez', 'hector.martinez@example.com', '990012645', '1999-04-05', 1, 31);
