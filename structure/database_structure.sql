...
CREATE TABLE IF NOT EXISTS `CLIENTE` (
  ...
  CONSTRAINT `FK_CLIENTE_COMUNAS` FOREIGN KEY (`ID_COMUNA`) REFERENCES `COMUNAS` (`ID_COMUNA`)
);
...
CREATE TABLE IF NOT EXISTS `MOTEL` (
  ...
  CONSTRAINT `FK_MOTEL_DUENO` FOREIGN KEY (`ID_DUENO`) REFERENCES `DUENO` (`ID_DUENO`),
  CONSTRAINT `FK_MOTEL_COMUNAS` FOREIGN KEY (`ID_COMUNA`) REFERENCES `COMUNAS` (`ID_COMUNA`)
);
...
-- Tabla CLIENTELOGS
CREATE TABLE IF NOT EXISTS `CLIENTELOGS` (
  `ID` INT NOT NULL AUTO_INCREMENT,
